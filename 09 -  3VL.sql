...
-- All-at-Once عملیات
SELECT
	OrderID, YEAR(OrderDate) AS OrderYear, OrderYear + 1 AS NextYear
FROM dbo.Orders;
GO

SELECT
	OrderID, YEAR(OrderDate) AS OrderYear, YEAR(OrderDate) + 1 AS NextYear
FROM dbo.Orders;
GO