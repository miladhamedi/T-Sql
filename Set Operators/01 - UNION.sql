...
-- ها توجه کنید Data Type به نحوه تبدیل
...
SELECT
	Tmp.Family ,Tmp.ID, DATALENGTH(Tmp.Family) AS Family_Space, DATALENGTH(Tmp.ID) AS ID_Space
